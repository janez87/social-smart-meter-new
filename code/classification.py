...
def activity_check(named_entities, annotations):
    ...
    activities = classify_image(annotations, activities)

    activities = classify_text(named_entities, activities)
...
def classify_image(annotations, activities):
    for annotation in annotations:
        activities = dictionary_check(annotation, activities)

    return activities


def classify_text(named_entities, activities):
    for ne in named_entities:
        activities = dictionary_check(ne, activities)
